# River Catchment
![Continuous Integration build in GitHub Actions](https://github.com/tbanyard/python-intermediate-catchment/actions/workflows/main.yml/badge.svg?branch=develop)
